...
//		String nowTime = strTemp.substring(8,14);
     ...
     * 获取时间差
     */
    public static Long getDifftime(Date startTime,Date endTime) {
	...
	public static Date getFirstDayOfMonth() {
		...
		try {
			return DateUtil.parse(str.toString(), new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"));
		} catch (ParseException e) {
			e.printStackTrace();
		}
		return null;
	...
	public static Date getLastDayOfMonth() {
		...
		Date theDate = calendar.getTime();
		String s = df.format(theDate);
		StringBuffer str = new StringBuffer().append(s).append(" 23:59:59.999");
		try {
			return DateUtil.parse(str.toString(), new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS"));
		} catch (ParseException e) {
			e.printStackTrace();
		}
		return null;
	...
	public static Date getFirstDayOfWeek()  {
		...
		Date theDate = calendar.getTime();
		theDate = increaseDay(theDate,1);
		String s = df.format(theDate);
		StringBuffer str = new StringBuffer().append(s).append(" 00:00:00.000");
		try {
			return DateUtil.parse(str.toString(), new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS"));
		} catch (ParseException e) {
			e.printStackTrace();
	...
	public static void main(String[] args) {
		System.out.println(DateUtil.formatDate(getFirstDayOfMonth(), "yyyy-MM-dd HH:mm:ss"));
		System.out.println(DateUtil.formatDate(getLastDayOfMonth(), "yyyy-MM-dd HH:mm:ss"));
		System.out.println(DateUtil.formatDate(getFirstDayOfWeek(), "yyyy-MM-dd HH:mm:ss"));
		System.out.println(DateUtil.formatDate(getLastDayOfWeek(), "yyyy-MM-dd HH:mm:ss"));
	}
